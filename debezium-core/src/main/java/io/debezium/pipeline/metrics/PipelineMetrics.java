 ...
 */
@ThreadSafe
public abstract class PipelineMetrics<B extends ChangeEventSourcePartitionMetrics>
        extends Metrics implements DataChangeEventListener, ChangeEventSourceTaskMetricsMXBean {

    private final ChangeEventQueueMetrics changeEventQueueMetrics;
    protected final CdcSourceTaskContext taskContext;
    private final Map<Partition, B> beans = new HashMap<>();
    ...
    protected <T extends CdcSourceTaskContext> PipelineMetrics(T taskContext, String contextName, ChangeEventQueueMetrics changeEventQueueMetrics,
                                                               ...
                                                               Function<Partition, B> beanFactory) {
    ...
    protected void onPartitionEvent(Partition partition, Consumer<B> handler) {
