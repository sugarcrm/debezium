...
public class LegacyV1SourceInfoTest {
    ...
    public void shouldOrderPositionWithoutGtidAsBeforePositionWithGtid() {
        assertPositionWithoutGtids("filename.01", Integer.MAX_VALUE, 0, 0).isBefore(positionWithGtids("11111111-1111-1111-1111-111111111111:1-5"));
    }

    @Test
    public void shouldOrderPositionWithGtidAsAfterPositionWithoutGtid() {
        assertPositionWithGtids("11111111-1111-1111-1111-111111111111:1-5").isAfter(positionWithoutGtids("filename.01", 0, 0, 0));
    }
